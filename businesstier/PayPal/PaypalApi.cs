...
namespace BusinessTier.PayPal
{
    ...
    public class PayPalAPI
    {
        ...
        public PayPalAPI()
        {
            ...
            caller.APIProfile = (IAPIProfile)PayPalProfile.DefaultProfile;
        }
            ...
            )
        {
            ...
            pp_Request.DoDirectPaymentRequestDetails.CreditCard.CardOwner.Address.CountryName = buyerCountry;
            if (buyerCountry == "USA")
            {
            ...
            {
                pp_Request.DoDirectPaymentRequestDetails.CreditCard.CardOwner.Address.Country = CountryCodeType.CA;
                pp_Request.DoDirectPaymentRequestDetails.CreditCard.CardOwner.PayerCountry = CountryCodeType.CA;
            }
