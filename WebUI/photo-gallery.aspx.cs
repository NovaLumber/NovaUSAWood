...
namespace WebUI
{
    ...
    public partial class photo_gallery : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                fl.Write("<a href=\"" + localPath + "/" + fi.Name + "\"><img alt=\"" + "hardwood " + fi.Name + "\" title=\"" + "hardwood " + fi.Name + "\" class=\"thumb\" src=\"" + thumbPath + "/" + fi.Name + "\" /></a>");
        ...
        private void ResizeImageTest(string photoPath, string newPath)
        {
            //do some testing
        }
