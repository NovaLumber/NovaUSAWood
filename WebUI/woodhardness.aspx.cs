...
namespace WebUI
{
    ...
    public partial class woodhardness : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SpecieRepeater.DataSource = daLayer.GetSpeciesHardness(isWood).Rows;
            SpecieRepeater.DataBind();

            UiMasterPage masterPage = (UiMasterPage)Master;

            masterPage.SetMetaTags(
                "Nova USA Wood Products - Janka Hardness of Wood",
            ...
            if (!IsPostBack)
            {
                ...
                div.Attributes.Add("class", "black");
            }
        }
    }
}