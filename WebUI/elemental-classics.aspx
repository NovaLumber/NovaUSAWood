<%@ Page EnableViewState="false" EnableSessionState="ReadOnly" Language="C#" MasterPageFile="~/UiMasterPage.Master" AutoEventWireup="true" CodeBehind="elemental-classics.aspx.cs" Inherits="WebUI.elemental_classics" Title="Untitled Page" %>
...
<div id="mainWithSideBar" class="elemental">
    ...
    <img alt="elemental classics" src="images/photo-elemental-classics-top.jpg" />
    
    <div class="align-left">
        <h1>Elemental Classics Collection</h1>
        <h2>Traditional fine hardwoods from northern temperate regions.</h2>
    ...
    <div class="align-right">
        <a href="products.aspx?FilterstoAdd=486" class="button-new">View ELEMENTAL Classics Collection</a>
        <img alt="elemental classics" src="images/photo-elemental-classics-side.jpg" />
    </div> <!-- end align-right -->
