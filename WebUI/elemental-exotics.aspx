<%@ Page EnableViewState="false" EnableSessionState="ReadOnly" Language="C#" MasterPageFile="~/UiMasterPage.Master" AutoEventWireup="true" CodeBehind="elemental-exotics.aspx.cs" Inherits="WebUI.elemental_exotics" Title="Untitled Page" %>
...
<div id="mainWithSideBar" class="elemental">
    <img alt="elemental exotics" src="images/photo-elemental-exotics-top.jpg" />
    <div class="align-left">
        <h1>Elemental Exotics Collection</h1>
        <h2>Gorgeous exotic hardwood flooring from around the world</h2>
    ...
    <div class="align-right">
        <a href="products.aspx?FilterstoAdd=456" class="button-new">View ELEMENTAL Exotics Collection</a>
        <img alt="elemental exotics" src="images/photo-elemental-exotics-side.jpg" />
    </div> <!-- end align-right -->
