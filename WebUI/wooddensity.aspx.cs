...
namespace WebUI
{
    ...
    public partial class wooddensity : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SpecieRepeater.DataSource = daLayer.GetSpeciesDensity(isWood).Rows;
            SpecieRepeater.DataBind();

            UiMasterPage masterPage = (UiMasterPage)Master;

            masterPage.SetMetaTags(
                "Nova USA Wood Products - Density of Wood",
