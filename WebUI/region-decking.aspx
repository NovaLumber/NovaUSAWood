<%@ Page Title="" Language="C#" MasterPageFile="~/UiMasterPage.Master" AutoEventWireup="true" CodeBehind="region-decking.aspx.cs" Inherits="WebUI.region_decking" %>

<asp:Content ID="Master" ContentPlaceHolderID="Header" runat="server">
    <title><%= myRegion.region_name %> Hardwood Decking, Batu | Ipe | Cumaru, Direct Shipment</title>
    <meta name="Description" content="Your source in <%= myRegion.region_name %> for Hardwood Decking in Batu, Ipe & Cumaru. Direct shipment to <%= myRegion.region_name %>." />
    <meta name="Keywords" content="<%= myRegion.region_name %>, <%= myRegion.region_abbrev %>, Batu, Ipe, Cumaru, Wholesaler, Hardwood Decking, Hardwood, Siding, Ceiling, Paneling, Boards, Lumber, Direct, Shipment" />
</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server"><div id="mainWithSideBar">
    ...
    <img alt="Batu Decking Modern Design" title="Batu Decking Modern Design" src="../theme/batu-close-up-740x375.jpg"  />

    <div class="leftColumn">
            <h1><%= myRegion.region_name %>'s Best Source for Hardwood Decking | Batu, Ipe & Cumaru</h1>

            <p>We can supply and ship to <%= myRegion.region_name %> from our <%= myRegion.region_closest_warehouse %> warehouse.
            Our premium hardwood decking products such as Batu Decking, Ipe Decking and Cumaru Decking are available for direct shipment to
            <%= myRegion.region_name %> from <%= myRegion.region_closest_warehouse %>.
            </p>

            <h2>Shipping to <%= myRegion.region_name %>?</h2>

            <p>Just give us a call to find out how we can ship our hardwood decking products to <%= myRegion.region_desc %> from our warehouse. 
            Nova has an extensive network of wholesale distributors and lumber yard retailers throughout the US and Canada. 
            Our hardwood decking distributors generally stock many of our wood deck products including Batu 1x4, Batu 1x6, Batu 5/4x4 and Batu 5/4x6; 
            Ipe 1x4, Ipe 1x6, Ipe 5/4x4 and Ipe 5/4x6; and Cumaru 1x4, Cumaru 1x6 and Cumaru 5/4x6.  
            </p>

            <h2>Batu, Ipe & Cumaru Hardwood Decking Accessories & Patterns</h2>
            
            <p>We stock at extensive amount of accessory items and can run a wide variety of custom patterns for just about any decking project you
            ...
            in decking, siding, ceiling, paneling and other interior or exterior projects.
            </p>
    ...
    <div class="rightColumn">
        <a href="products.aspx?FilterstoAdd=451" class="button-new" title="View Hardwood Decking Products" alt="View Nova Hardwood Decking Products" style="margin-left: 10px;">View Hardwood Decking Products</a>
            ...
            <asp:Repeater ID="RegionRepeater" runat="server">
                <ItemTemplate>
                    <a href="<%#((BusinessTier.DataAccessLayer.RegionWeb.region_webRow)Container.DataItem).url.ToString() %>"> <%#((BusinessTier.DataAccessLayer.RegionWeb.region_webRow)Container.DataItem).region_desc.ToString() %> </a>
                    &nbsp;  &nbsp
                </ItemTemplate>                    
            </asp:Repeater>
            </div>
