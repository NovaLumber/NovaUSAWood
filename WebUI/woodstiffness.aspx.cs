...
namespace WebUI
{
    ...
    public partial class woodstiffness : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SpecieRepeater.DataSource = daLayer.GetSpeciesMOE(isWood).Rows;
            SpecieRepeater.DataBind();

            UiMasterPage masterPage = (UiMasterPage)Master;

            masterPage.SetMetaTags(
                "Nova USA Wood Products - Wood Stiffness, MOE",
